...
public class VerilogCoreFileEmitter extends TemplateEmitter {
    private static final String DEFAULT_TEMPLATE_FILE = "/templates/template_config_core.stg";
    private static final String DEFAULT_TEMPLATE_NAME = "core_config_sv";

    public VerilogCoreFileEmitter(Module module) { super(module, DEFAULT_TEMPLATE_FILE, DEFAULT_TEMPLATE_NAME); }
