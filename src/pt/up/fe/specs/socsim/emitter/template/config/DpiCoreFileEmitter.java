...
public class DpiCoreFileEmitter extends TemplateEmitter {
    ...
    public DpiCoreFileEmitter(Module module) { super(module, DEFAULT_TEMPLATE_FILE, DEFAULT_TEMPLATE_NAME); }
